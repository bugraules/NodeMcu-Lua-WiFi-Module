...
--corrected version
gpio.serout(1,1,{5000,995000},2, function() print("done") end) -- asynchronous max 2 flashes 5 ms long every second with a callback function when done
gpio.serout(1,1,{5000,995000},2, 1) -- asynchronous max 2 flashes 5 ms long, no callback // nodemcu
